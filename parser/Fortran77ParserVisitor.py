...
class Fortran77ParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by Fortran77Parser#typename_.
    def visitTypename_(self, ctx:Fortran77Parser.Typename_Context):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by Fortran77Parser#type_.
    def visitType_(self, ctx:Fortran77Parser.Type_Context):
        return self.visitChildren(ctx)
